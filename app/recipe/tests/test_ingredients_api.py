...
def detail_url(ingredient_id):
    """Create and retiurn detial url for Ingredient"""
...
class PublicsIngredientsApiTests(TestCase):
...
class PrivateIngredientsApiTests(TestCase):
    ...
    def test_ingredients_limited_to_user(self):
        ...
        Ingredient.objects.create(user=user2, name='Dal')
